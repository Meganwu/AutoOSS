                ...
                if len(img_prop_small.contours)>0 and len(img_prop_small.contours_max)>10 and  len(img_prop_small.detect_mols_from_contours)>0:
                        ...
                        if img_prop_small.area<2.8 and img_prop_small.area>0.5:
                                ...
                                if  mol_center_x_nm>scan_mol_x_nm-scan_len_nm_small/8 and mol_center_x_nm<scan_mol_x_nm+scan_len_nm_small/8 and mol_center_y_nm>scan_mol_y_nm+scan_len_nm_small*3/8 and mol_center_y_nm<scan_mol_y_nm+scan_len_nm_small*5/8: # and img_cnn_detect_mol:
                                        ...
                                        if img_prop_small.area<2.8 and img_prop_small.area>0.8: # and img_cnn_detect_mol:
                        ...
                        while not found_mol:
                                ...
                                for i in range(candidate_mols_num):
                                        ...
                                        if len(img_prop_small.contours)>0 and len(img_prop_small.contours_max)>10 and  len(img_prop_small.detect_mols_from_contours)>0  and img_cnn_detect_mol_2:
                                                img_prop_small.contour_property()
                                                self.state=img_feat+[img_prop_small.ellipse_x, img_prop_small.ellipse_y, img_prop_small.ellipse_width, img_prop_small.ellipse_height, img_prop_small.ellipse_angle]
